            ...
            if la_ == 1:
                ...
                while _la == SqlBaseParser.COMMENT or (
                    ...
                    and (
                        (1 << (_la - 183))
                        & (
                            (1 << (SqlBaseParser.OPTIONS - 183))
                            | (1 << (SqlBaseParser.TBLPROPERTIES - 183))
                            | (1 << (SqlBaseParser.LOCATION - 183))
                            | (1 << (SqlBaseParser.CLUSTERED - 183))
                            | (1 << (SqlBaseParser.PARTITIONED - 183))
                        )
                    )
                    != 0
                ):
                ...
                if (
                    ...
                    or (
                        ...
                        and (
                            (1 << (_la - 77))
                            & (
                                (1 << (SqlBaseParser.WITH - 77))
                                | (1 << (SqlBaseParser.VALUES - 77))
                                | (1 << (SqlBaseParser.TABLE - 77))
                                | (1 << (SqlBaseParser.INSERT - 77))
                                | (1 << (SqlBaseParser.MAP - 77))
                            )
                        )
                        != 0
                    )
                ...
                while (
                    ...
                    or (
                        ...
                        and (
                            (1 << (_la - 185))
                            & (
                                (1 << (SqlBaseParser.TBLPROPERTIES - 185))
                                | (1 << (SqlBaseParser.SKEWED - 185))
                                | (1 << (SqlBaseParser.STORED - 185))
                                | (1 << (SqlBaseParser.LOCATION - 185))
                                | (1 << (SqlBaseParser.CLUSTERED - 185))
                                | (1 << (SqlBaseParser.PARTITIONED - 185))
                            )
                        )
                        != 0
                    )
                ...
                if (
                    (
                        ...
                        and (
                            (1 << (_la - 90))
                            & (
                                (1 << (SqlBaseParser.LOGICAL - 90))
                                | (1 << (SqlBaseParser.CODEGEN - 90))
                                | (1 << (SqlBaseParser.COST - 90))
                            )
                        )
                        != 0
                    )
                ...
                if (
                    ...
                    or (
                        ...
                        and (
                            (1 << (_la - 64))
                            & (
                                (1 << (SqlBaseParser.WINDOW - 64))
                                | (1 << (SqlBaseParser.OVER - 64))
                                | (1 << (SqlBaseParser.PARTITION - 64))
                    ...
                    or (
                        ...
                        and (
                            (1 << (_la - 128))
                            & (
                                (1 << (SqlBaseParser.POSITION - 128))
                                | (1 << (SqlBaseParser.EXTRACT - 128))
                                | (1 << (SqlBaseParser.DIV - 128))
                                | (1 << (SqlBaseParser.PERCENTLIT - 128))
                                | (1 << (SqlBaseParser.BUCKET - 128))
                                | (1 << (SqlBaseParser.OUT - 128))
                                | (1 << (SqlBaseParser.OF - 128))
                                | (1 << (SqlBaseParser.SORT - 128))
                                | (1 << (SqlBaseParser.CLUSTER - 128))
                                | (1 << (SqlBaseParser.DISTRIBUTE - 128))
                                | (1 << (SqlBaseParser.OVERWRITE - 128))
                                | (1 << (SqlBaseParser.TRANSFORM - 128))
                                | (1 << (SqlBaseParser.REDUCE - 128))
                                | (1 << (SqlBaseParser.SERDE - 128))
                                | (1 << (SqlBaseParser.SERDEPROPERTIES - 128))
                                | (1 << (SqlBaseParser.RECORDREADER - 128))
                                | (1 << (SqlBaseParser.RECORDWRITER - 128))
                                | (1 << (SqlBaseParser.DELIMITED - 128))
                                | (1 << (SqlBaseParser.FIELDS - 128))
                                | (1 << (SqlBaseParser.TERMINATED - 128))
                                | (1 << (SqlBaseParser.COLLECTION - 128))
                                | (1 << (SqlBaseParser.ITEMS - 128))
                                | (1 << (SqlBaseParser.KEYS - 128))
                                | (1 << (SqlBaseParser.ESCAPED - 128))
                                | (1 << (SqlBaseParser.LINES - 128))
                                | (1 << (SqlBaseParser.SEPARATED - 128))
                                | (1 << (SqlBaseParser.FUNCTION - 128))
                                | (1 << (SqlBaseParser.EXTENDED - 128))
                                | (1 << (SqlBaseParser.REFRESH - 128))
                                | (1 << (SqlBaseParser.CLEAR - 128))
                                | (1 << (SqlBaseParser.CACHE - 128))
                                | (1 << (SqlBaseParser.UNCACHE - 128))
                                | (1 << (SqlBaseParser.LAZY - 128))
                                | (1 << (SqlBaseParser.FORMATTED - 128))
                                | (1 << (SqlBaseParser.GLOBAL - 128))
                                | (1 << (SqlBaseParser.TEMPORARY - 128))
                                | (1 << (SqlBaseParser.OPTIONS - 128))
                                | (1 << (SqlBaseParser.UNSET - 128))
                                | (1 << (SqlBaseParser.TBLPROPERTIES - 128))
                                | (1 << (SqlBaseParser.DBPROPERTIES - 128))
                                | (1 << (SqlBaseParser.BUCKETS - 128))
                                | (1 << (SqlBaseParser.SKEWED - 128))
                                | (1 << (SqlBaseParser.STORED - 128))
                                | (1 << (SqlBaseParser.DIRECTORIES - 128))
                    ...
                    or (
                        ...
                        and (
                            (1 << (_la - 192))
                            & (
                                (1 << (SqlBaseParser.EXCHANGE - 192))
                                | (1 << (SqlBaseParser.ARCHIVE - 192))
                                | (1 << (SqlBaseParser.UNARCHIVE - 192))
                                | (1 << (SqlBaseParser.FILEFORMAT - 192))
                                | (1 << (SqlBaseParser.TOUCH - 192))
                                | (1 << (SqlBaseParser.COMPACT - 192))
                                | (1 << (SqlBaseParser.CONCATENATE - 192))
                                | (1 << (SqlBaseParser.CHANGE - 192))
                                | (1 << (SqlBaseParser.CASCADE - 192))
                                | (1 << (SqlBaseParser.RESTRICT - 192))
                                | (1 << (SqlBaseParser.CLUSTERED - 192))
                                | (1 << (SqlBaseParser.SORTED - 192))
                                | (1 << (SqlBaseParser.PURGE - 192))
                                | (1 << (SqlBaseParser.INPUTFORMAT - 192))
                                | (1 << (SqlBaseParser.OUTPUTFORMAT - 192))
                                | (1 << (SqlBaseParser.DATABASE - 192))
                                | (1 << (SqlBaseParser.DATABASES - 192))
                                | (1 << (SqlBaseParser.DFS - 192))
                                | (1 << (SqlBaseParser.TRUNCATE - 192))
                                | (1 << (SqlBaseParser.ANALYZE - 192))
                                | (1 << (SqlBaseParser.COMPUTE - 192))
                                | (1 << (SqlBaseParser.LIST - 192))
                                | (1 << (SqlBaseParser.STATISTICS - 192))
                                | (1 << (SqlBaseParser.PARTITIONED - 192))
                                | (1 << (SqlBaseParser.EXTERNAL - 192))
                                | (1 << (SqlBaseParser.DEFINED - 192))
                                | (1 << (SqlBaseParser.REVOKE - 192))
                                | (1 << (SqlBaseParser.GRANT - 192))
                                | (1 << (SqlBaseParser.LOCK - 192))
                                | (1 << (SqlBaseParser.UNLOCK - 192))
                                | (1 << (SqlBaseParser.MSCK - 192))
                                | (1 << (SqlBaseParser.REPAIR - 192))
                                | (1 << (SqlBaseParser.RECOVER - 192))
                                | (1 << (SqlBaseParser.EXPORT - 192))
                                | (1 << (SqlBaseParser.IMPORT - 192))
                                | (1 << (SqlBaseParser.LOAD - 192))
                                | (1 << (SqlBaseParser.ROLE - 192))
                                | (1 << (SqlBaseParser.ROLES - 192))
                                | (1 << (SqlBaseParser.COMPACTIONS - 192))
                                | (1 << (SqlBaseParser.PRINCIPALS - 192))
                                | (1 << (SqlBaseParser.TRANSACTIONS - 192))
                                | (1 << (SqlBaseParser.INDEX - 192))
                                | (1 << (SqlBaseParser.INDEXES - 192))
                                | (1 << (SqlBaseParser.LOCKS - 192))
                                | (1 << (SqlBaseParser.OPTION - 192))
                                | (1 << (SqlBaseParser.ANTI - 192))
                                | (1 << (SqlBaseParser.LOCAL - 192))
                                | (1 << (SqlBaseParser.INPATH - 192))
                                | (1 << (SqlBaseParser.STRING - 192))
                                | (1 << (SqlBaseParser.IDENTIFIER - 192))
                                | (1 << (SqlBaseParser.BACKQUOTED_IDENTIFIER - 192))
                            )
                        )
                        != 0
                    )
            ...
            if (
                ...
                or (
                    ...
                    and (
                        (1 << (_la - 240))
                        & (
                            (1 << (SqlBaseParser.STRING - 240))
                            | (1 << (SqlBaseParser.INTEGER_VALUE - 240))
                            | (1 << (SqlBaseParser.DECIMAL_VALUE - 240))
                        )
                    )
                    != 0
                )
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << (_la - 102))
                                    & (
                                        (1 << (SqlBaseParser.UNION - 102))
                                        | (1 << (SqlBaseParser.EXCEPT - 102))
                                        | (1 << (SqlBaseParser.SETMINUS - 102))
                    ...
                    or (
                        ...
                        and (
                            ...
                            & (
                                (1 << (SqlBaseParser.POSITION - 128))
                                | (1 << (SqlBaseParser.EXTRACT - 128))
                                | (1 << (SqlBaseParser.PLUS - 128))
                                | (1 << (SqlBaseParser.MINUS - 128))
                                | (1 << (SqlBaseParser.ASTERISK - 128))
                                | (1 << (SqlBaseParser.DIV - 128))
                                | (1 << (SqlBaseParser.TILDE - 128))
                                | (1 << (SqlBaseParser.PERCENTLIT - 128))
                                | (1 << (SqlBaseParser.BUCKET - 128))
                                | (1 << (SqlBaseParser.OUT - 128))
                                | (1 << (SqlBaseParser.OF - 128))
                    ...
                    or (
                        ...
                        and (
                            ...
                            & (
                                ...
                                | (1 << (SqlBaseParser.INPATH - 192))
                                | (1 << (SqlBaseParser.STRING - 192))
                                | (1 << (SqlBaseParser.BIGINT_LITERAL - 192))
                                | (1 << (SqlBaseParser.SMALLINT_LITERAL - 192))
                                | (1 << (SqlBaseParser.TINYINT_LITERAL - 192))
                                | (1 << (SqlBaseParser.INTEGER_VALUE - 192))
                                | (1 << (SqlBaseParser.DECIMAL_VALUE - 192))
                                | (1 << (SqlBaseParser.DOUBLE_LITERAL - 192))
                                | (1 << (SqlBaseParser.BIGDECIMAL_LITERAL - 192))
                                | (1 << (SqlBaseParser.IDENTIFIER - 192))
                                | (1 << (SqlBaseParser.BACKQUOTED_IDENTIFIER - 192))
                            )
                        )
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 138))
                            & (
                                (1 << (SqlBaseParser.PLUS - 138))
                                | (1 << (SqlBaseParser.MINUS - 138))
                                | (1 << (SqlBaseParser.TILDE - 138))
                            )
                        )
                        != 0
                    )
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << (_la - 140))
                                    & (
                                        (1 << (SqlBaseParser.ASTERISK - 140))
                                        | (1 << (SqlBaseParser.SLASH - 140))
                                        | (1 << (SqlBaseParser.PERCENT - 140))
                                        | (1 << (SqlBaseParser.DIV - 140))
                                    )
                                )
                                != 0
                            )
                            ...
                            (
                                ...
                                and (
                                    ...
                                    & (
                                        (1 << (SqlBaseParser.PLUS - 138))
                                        | (1 << (SqlBaseParser.MINUS - 138))
                                        | (1 << (SqlBaseParser.CONCAT_PIPE - 138))
                                    )
                                )
                                != 0
                            )
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 124))
                            & (
                                (1 << (SqlBaseParser.BOTH - 124))
                                | (1 << (SqlBaseParser.LEADING - 124))
                                | (1 << (SqlBaseParser.TRAILING - 124))
                            )
                        )
                        != 0
                    )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 130))
                        & (
                            (1 << (SqlBaseParser.EQ - 130))
                            | (1 << (SqlBaseParser.NSEQ - 130))
                            | (1 << (SqlBaseParser.NEQ - 130))
                            | (1 << (SqlBaseParser.NEQJ - 130))
                            | (1 << (SqlBaseParser.LT - 130))
                            | (1 << (SqlBaseParser.LTE - 130))
                            | (1 << (SqlBaseParser.GT - 130))
                            | (1 << (SqlBaseParser.GTE - 130))
                        )
                    )
                    != 0
                )
                ...
                (
                    ...
                    and (
                        ...
                        & (
                            (1 << (SqlBaseParser.PLUS - 138))
                            | (1 << (SqlBaseParser.MINUS - 138))
                            | (1 << (SqlBaseParser.ASTERISK - 138))
                            | (1 << (SqlBaseParser.SLASH - 138))
                            | (1 << (SqlBaseParser.PERCENT - 138))
                            | (1 << (SqlBaseParser.DIV - 138))
                            | (1 << (SqlBaseParser.TILDE - 138))
                            | (1 << (SqlBaseParser.AMPERSAND - 138))
                            | (1 << (SqlBaseParser.PIPE - 138))
                            | (1 << (SqlBaseParser.CONCAT_PIPE - 138))
                            | (1 << (SqlBaseParser.HAT - 138))
                        )
                    )
                    != 0
                )
